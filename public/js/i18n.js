...
var I18n = (function() {
  ...
  var translations = {
    he: {
      ...
      auth_or: 'או',
      auth_google_login: 'כניסה עם Google',
      auth_google_register: 'הרשמה עם Google',
      auth_google_e2e_blocked: 'חשבונך במצב E2E — יש להיכנס עם סיסמה. אם ברצונך להשתמש בכניסה עם Google, בטל את מצב E2E בהגדרות.',
      // Calendar
      ...
      settings_password_current: 'סיסמה נוכחית',
      settings_password_new: 'סיסמה חדשה',
      settings_password_confirm: 'אימות סיסמה חדשה',
      settings_password_set: 'הגדרת סיסמה',
      settings_password_change: 'שינוי סיסמה',
      settings_password_set_desc: 'נרשמת עם Google — הגדר סיסמה כדי לאפשר כניסה עם מייל וסיסמה.',
      settings_password_change_desc: 'שינוי הסיסמה הנוכחית.',
      settings_password_save: 'שמור סיסמה',
      settings_password_saved: 'הסיסמה עודכנה ✓',
      settings_password_required_for_e2e: 'יש להגדיר סיסמה לפני מעבר למצב E2E.',
      // Encryption
      enc_e2e_title: '🔒 מצב E2E (הצפנה מקצה לקצה)',
      enc_e2e_desc: 'הנתונים מוצפנים באופן מוחלט עם הסיסמה שלך. רק אתה יכול לפענח אותם. תזכורות באימייל, API, MCP וכניסה עם Google אינם זמינים במצב זה.',
      enc_enable_extended: 'חזרה למצב מורחב (הפעלת כל הפיצ׳רים)',
      enc_extended_title: '🔔 מצב מורחב (API + תזכורות)',
      enc_extended_desc: 'תזכורות באימייל, API, MCP, כניסה עם Google ושחזור סיסמה פעילים. הנתונים מוצפנים ומוגנים — אך המערכת מסוגלת לעבד אותם באופן אוטומטי.',
      enc_disable_extended: 'מעבר למצב E2E (הצפנה מקסימלית)',
      enc_disable_confirm: 'מעבר למצב E2E יבטל:\n• כניסה עם Google\n• תזכורות באימייל\n• גישת API ו-MCP\n• שחזור סיסמה\n\nהאם להמשיך?',
      ...
      enc_tooltip_extended: 'מצב מורחב: הנתונים מוצפנים באחסון. המערכת מסוגלת לפענח לצרכי תזכורות ו-API. זהו רמת ההגנה הרגילה — דומה לאפליקציות בנקאיות.',
      enc_tooltip_e2e: 'מצב E2E: רק הסיסמה שלך יכולה לפענח את הנתונים. אפילו בעל האתר לא יכול לגשת אליהם. אין כניסה עם Google, אין תזכורות, אין API, אין שחזור סיסמה.',
      // Cities
    ...
    en: {
      ...
      auth_google_e2e_blocked: 'Your account is in E2E mode — please sign in with your password. To use Google sign-in, disable E2E mode in Settings.',
      // Calendar
      ...
      settings_password_set: 'Set Password',
      settings_password_change: 'Change Password',
      settings_password_set_desc: 'You signed up with Google — set a password to enable email+password login.',
      settings_password_change_desc: 'Change your current password.',
      settings_password_save: 'Save Password',
      settings_password_saved: 'Password updated ✓',
      settings_password_required_for_e2e: 'You must set a password before switching to E2E mode.',
      // Encryption
      enc_e2e_title: '🔒 E2E Mode (End-to-End Encryption)',
      enc_e2e_desc: 'Data is fully encrypted with your password. Only you can decrypt it. Email reminders, API, MCP, Google login, and password recovery are disabled in this mode.',
      enc_enable_extended: 'Return to Extended Mode (enable all features)',
      enc_extended_title: '🔔 Extended Mode (API + Reminders)',
      enc_extended_desc: 'Email reminders, API, MCP, Google login, and password recovery are active. Your data is encrypted and protected — but the system can process it automatically.',
      enc_disable_extended: 'Switch to E2E Mode (maximum encryption)',
      enc_disable_confirm: 'Switching to E2E will disable:\n• Google sign-in\n• Email reminders\n• API & MCP access\n• Password recovery\n\nContinue?',
      ...
      enc_tooltip_extended: 'Extended Mode: Your data is encrypted at rest. The system can decrypt it for automated features (reminders, API). This is the standard protection level — similar to banking apps.',
      enc_tooltip_e2e: 'E2E Mode: Only your password can decrypt data. Even the site owner cannot access it. However: no Google sign-in, no reminders, no API, no password recovery.',
      // Cities
